        ...
        <div id="login"><h1><a href="http://kohanaframework.org/" title="Powered by kohana">kohanaPress</a></h1>
            ...
            <form name="loginform" id="loginform" action="" method="post">
                ...
                <p class="submit">
                    ...
                    <input type="hidden" name="redirect_to" value="/kohana/test12" />
                    <input type="hidden" name="testcookie" value="1" />
                </p>
            </form>

            <p id="nav">
                <a href="/kohana/test12_register">登録</a> |
            ...
            <p id="backtoblog"><a href="/kohana/test12" title="迷子になってしまいましたか ?">&larr; kohanaPress へ戻る</a></p>
        </div>

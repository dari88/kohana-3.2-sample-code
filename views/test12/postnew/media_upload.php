...
<link rel='stylesheet' href='/kohana/loadcss?c=1&dir=ltr&load=wp-admin,media' type='text/css' media='all' />
...
<script type='text/javascript' src='/kohana/loadjs?c=1&load=jquery,utils,plupload,plupload-html5,plupload-flash,plupload-silverlight,plupload-html4,plupload-handlers,json2'></script>
</head>
...
document.body.className = document.body.className.replace('no-js', 'js');
	...
	<ul id='sidemenu'>
	<li id='tab-type'><a href='/kohana/test12_mediaupload' class='current'>コンピューターから</a></li>
	<li id='tab-type_url'><a href='/kohana/test12_mediaupload'>URL から</a></li>
	<li id='tab-library'><a href='/kohana/test12_mediaupload'>メディアライブラリ</a></li>
</ul>
	</div>
	
<form enctype="multipart/form-data" method="post" action="/kohana/test12_mediaupload" class="media-upload-form type-form validate" id="image-form">
<input type="submit" name="save" id="save" class="hidden" value="変更を保存"  /><input type="hidden" name="post_id" id="post_id" value="61" />
<input type="hidden" id="_wpnonce" name="_wpnonce" value="e6e3bef16a" /><input type="hidden" name="_wp_http_referer" value="/kohana/test12_mediaupload" />
...
<script type='text/javascript' src='/kohana/loadjs?c=1&load=hoverIntent,common,jquery-color,imgareaselect,image-edit,set-post-thumbnail'></script>

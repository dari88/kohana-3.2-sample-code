                    ...
                    <tr id='post-83' class='author-self status-inherit' valign="top">
                        ...
                        <td class='title column-title'>
                            ...
                            <div class="row-actions">
                                <span class='edit'><a href="/kohana/test12_upload">編集</a> | </span>
                                <span class='delete'><a class='submitdelete' onclick='return showNotice.warn();' href='/kohana/test12_upload?page=<?php echo $page ?>&action=delete&media[]=<?php echo $id ?>'>完全に削除する</a> | </span>
                                <span class='view'><a href="/kohana/test12_upload" title="&#8220;自動下書き&#8221; を表示" rel="permalink">表示</a></span>
                            </div>		
                        </td>

<div class="wrap">
    ...
    <ul class='subsubsub'>
        <li class='all'><a href='/kohana/test12_edit?option=all'>すべて <span class="count"></span></a> |</li>
        <li class='publish'><a href='/kohana/test12_edit'>公開済み <span class="count"></span></a> |</li>
        <li class='draft'><a href='/kohana/test12_edit?option=draft'>下書き <span class="count"></span></a> |</li>
        <li class='trash'><a href='/kohana/test12_edit?option=trash'>ゴミ箱 <span class="count"></span></a></li>
    </ul>
    <form id="posts-filter" action="" method="get">

        <input type="hidden" name="_wp_http_referer" value="/kohana/test12_edit" />
...
//                    $extention = $d['extention'];
                    ...
                    <tr valign="top" class="post-106 post type-post status-publish format-standard hentry category-1 alternate iedit author-self" id="post-106">
                        ...
                        <td class="post-title page-title column-title"><strong><a title="これを編集する" href="/kohana/test12_postnew?id=<?php echo $id ?>&action=edit" class="row-title"><?php echo $post_title ?></a></strong>
                            <div class="row-actions"><span class="edit"><a title="この項目を編集" href="/kohana/test12_postnew?id=<?php echo $id ?>&action=edit">編集</a> | </span>
                                <span class="inline hide-if-no-js"><a title="この項目をインラインで編集" class="editinline" href="#">クイック編集</a> | </span>
                                <span class="trash"><a href="/kohana/test12_edit?action=trash&post[]=<?php echo $id ?>&page=<?php echo $page ?>&option=<?php echo $option ?>" title="この項目をゴミ箱へ移動する " class="submitdelete">ゴミ箱</a> | </span>
                                <span class="view"><a rel="permalink" title="これを表示" href="/kohana/test12?p=<?php echo $id ?>">表示</a></span>
                            </div>
                        ...
                        <td class="author column-author"><a href="/kohana/test12_edit"><?php echo $user_login ?></a></td>

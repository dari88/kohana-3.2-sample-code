...
class Zend_Mail_Storage_Folder_Mbox extends Zend_Mail_Storage_Mbox implements Zend_Mail_Storage_Folder_Interface
{
    ...
    public function __construct($params)
    {
        ...
        if (isset($params->filename)) {
            ...
            throw new Exception('use Zend_Mail_Storage_Mbox for a single file');
        }
    ...
    protected function _buildFolderTree($currentDir, $parentFolder = null, $parentGlobalName = '')
    {
        ...
        if (!$dh) {
             ...
             */
            // require_once 'Zend/Mail/Storage/Exception.php';
            throw new Exception("can't read dir $currentDir");
        }
    ...
    public function getFolders($rootFolder = null)
    {
        ...
        if ($currentFolder->getGlobalName() != DIRECTORY_SEPARATOR . trim($rootFolder, DIRECTORY_SEPARATOR)) {
             ...
             */
            // require_once 'Zend/Mail/Storage/Exception.php';
            throw new Exception("folder $rootFolder not found");
        }
    ...
    public function selectFolder($globalName)
    {
        ...
        try {
            ...
            if (!$folder->isSelectable()) {
                 ...
                 */
                // require_once 'Zend/Mail/Storage/Exception.php';
                throw new Exception("{$this->_currentFolder} is not selectable", 0, $e);
            }
             ...
             */
            // require_once 'Zend/Mail/Storage/Exception.php';
            throw new Exception('seems like the mbox file has vanished, I\'ve rebuild the ' .

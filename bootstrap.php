...
* Cookie settings
*/
Cookie::$salt = 'd$eauonab%samnaeyu&vsno@Is*nla+p';
Cookie::$expiration = 604800; // 1 week
Cookie::$path = '/kohana/'; // Allow cookies only when going to
Cookie::$secure = FALSE; // TRUE = accessed only on a secure(HTTPS) connection
Cookie::$httponly = TRUE; // Make cookies inaccessible to Javascript